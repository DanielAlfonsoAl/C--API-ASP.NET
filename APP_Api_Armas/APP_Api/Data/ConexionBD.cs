...
namespace APP_Api_Armas.Data
{
    public class ConexionBD
    {
        ...
        private bool AbrirConexion()
        {
            try
            {
                // strCadenaCnx = "Data Source=ARMDFPCCIFSD031\\SQLEXPRESS;Initial Catalog=DB_API_DATOS;Integrated Security=True";*
                strCadenaCnx = "workstation id=DVM-2448515.mssql.somee.com;packet size=4096;user id=Daniel2303_SQLLogin_1;pwd=6y85vzgso8;data source=DVM-2448515.mssql.somee.com;persist security info=False;initial catalog=DVM-2448515";
